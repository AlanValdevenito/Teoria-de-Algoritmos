...
# El algoritmo tiene como regla sencilla en cada iteracion appendear o popear las aberturas dependiendo del caracter actual.
...
def expresion_balanceada(cadena):
    pila = []
    ...
    return len(pila) == 0  # Si la pila está vacía, la cadena está balanceada

assert expresion_balanceada("()") == True
assert expresion_balanceada("(())") == True
assert expresion_balanceada("(()())") == True
assert expresion_balanceada(")(") == False
assert expresion_balanceada("(()") == False
assert expresion_balanceada("())") == False
assert expresion_balanceada("()()") == True
assert expresion_balanceada("(())") == True
